...
import AboutSVG from "../../assets/images/profile.png";
import "./About.scss";
      ...
      <div className="app__about-container">
        <div className="app__about-container_text">
          ...
          <p>
            ...
            Hello! My name is Bella. My journey in tech began with my eCommerce biodevice startup, <b>Brallium</b>, 
            supported by an investment of <b>$10,000</b>, 
          </p>

          <p>
          Inspired by my internship at <b>FOX Corporation,</b> I developed AI-driven productivity tools for B2B and B2C markets, 
          securing support from <b>Y Combinator, Blackstone LaunchPad, Google AI Startup, and the Honors Fund</b>.
          <p>
            I am passionate about pioneering innovative tech solutions that address real-world challenges and create meaningful impact.
          </p>
          </p>
        </div>
